...
Usage:
  python crs8_qwen_final.py --layouts path/to/layouts.json
  python crs8_qwen_final.py --layouts layouts.json --furniture "bed,desk,wardrobe"
  python crs8_qwen_final.py --layouts layouts.json --direct-threshold 4 --strict-validation
"""
...
def main():
    ...
    llm      = QwenAgent(model_id=args.llm, host=args.ollama_host)
